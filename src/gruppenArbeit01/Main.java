...
//TODO: MWST Berechnung �berpr�fen (stimmt nicht)
//TODO: Kommentare
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Product pr1 = new Product(1, "K�sekuchen", 11.10f, 1.0f);
		...
		while (true) {
			...
			// id (which product)
			System.out.println("\n" + "Welcher Artikel soll dem Warenkorb hinzugef�gt werden (1,2,3 oder q f�r Ende)");
			...
			System.out.println("Wie viele Artikel " + assortmentItem.getItemName()
					+ " sollen hinzugef�gt werden: (Zahl oder a f�r Abbrechen)");
